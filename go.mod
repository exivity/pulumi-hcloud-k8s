module github.com/exivity/pulumi-hcloud-k8s
...
require (
	...
	github.com/exivity/pulumi-hcloud-upload-image v0.0.3 // indirect
	...
	github.com/pulumi/pulumi-go-provider v1.1.0 // indirect
